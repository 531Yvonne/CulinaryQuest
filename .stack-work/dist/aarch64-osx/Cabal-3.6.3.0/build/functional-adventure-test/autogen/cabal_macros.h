...
/* package hspec-discover-2.9.7 */
#ifndef VERSION_hspec_discover
#define VERSION_hspec_discover "2.9.7"
...
#define CURRENT_COMPONENT_ID "functional-adventure-0.1.0.0-EJaRrLbgIUqCHKDMoEnTTA-functional-adventure-test"
